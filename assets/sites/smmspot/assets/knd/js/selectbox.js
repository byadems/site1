...
// Create a MutationObserver for selectInp
let observerOptions = new MutationObserver(function(mutations) {
...
observerOptions.observe(selectInp, config);

// Initial call to handle changes on page load
handleOptionsChange();

// Function to search within nodes
