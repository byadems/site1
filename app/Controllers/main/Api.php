...
class Api extends BaseController
{
    function index()
    {
        ...
        if (isset($_POST)) {
           ...
           // $orderid = isset($_POST["order"]) ? htmlspecialchars($_POST["order"]) : 0;
            ...
            elseif ($clientDetail["client_type"] == 1):
                ...
                elseif ($action == "services"):
                    ...
                    foreach ($servicesRows as $serviceRow) {
                        ...
                        if (($serviceRow["service_secret"] == 2 || $search->rowCount()) && ($serviceRow["category_secret"] == 2 || $search2->rowCount())):
                            //$s["rate"] = service_price($serviceRow["service_id"], $clientDetail["client_id"]);
                            ...
                            $s['description'] = htmlspecialchars($serviceRow["service_description"]);
                ...
                elseif ($action == "addTicket"):
                    ...
                    if ($this->validate($rules)):
                        ...
                        $output = array('success' => "Başarıyla " . $ticketid . " idli " . htmlspecialchars($this->request->getPost('subject')) . " başlıklı destek talebiniz açıldı", 'status' => 202, 'ticket_id' => $ticketid);
                    else:
                ...
                elseif ($action == "add"):
                    ...
                    if (($serviceDetail["service_secret"] == 2 || $search->rowCount()) && $serviceDetail["category_type"] == 2 && $serviceDetail["service_type"] == 2 && ($serviceDetail["category_secret"] == 2 || $search2->rowCount())):
                        ...
                        if ($username != ""):
                            ...
                            $price = service_price($serviceDetail["service_id"], $clientDetail["client_id"]);
                        ...
                        elseif ($serviceDetail["service_package"] == 3 || $serviceDetail["service_package"] == 4):
                            ...
                            $price = service_price($serviceDetail["service_id"], $clientDetail["client_id"]) / 1000 * $quantity;
