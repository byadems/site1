        ...
        $colums = array(
            ...
            array(
                ...
                "formatter" => function ($d, $row) {
                    ...
                    $link = base_url($this->settings['adminkey']."/client-detail/" . $row['client_id']);
                    return '<a href="' . $link . '"
                                           target="_blank"
                                           class="text-glycon">
                    ...
                    $return = '<div class="dropdown text-center">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item"
                                                       href="' . base_url($this->settings['adminkey']."/order-detail/" . $row['order_id']) . '">Servis
                                                        Detayı</a></li>
                                                <hr>';
                        ...
                        $return .= '<li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="' . base_url($this->settings['adminkey']."/orders/order_resend/" . $row["order_id"]) . '">Yeniden
                                                            Gönder</a></li> <hr>';
                    endif;
                    ...
                    $return .= '
                                                <li>
                                                    <a class="dropdown-item"
                                                       ...
                                                       data-href="' . base_url($this->settings['adminkey']."/orders/order_cancel/" . $row["order_id"]) . '">İptal
                                                        ve İade Et</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="#"
                                                       data-bs-toggle="modal" data-bs-target="#confirmChange"
                                                       data-href="' . base_url($this->settings['adminkey']."/orders/order_complete/" . $row["order_id"]) . '">Tamamlandı</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="#"
                                                       data-bs-toggle="modal" data-bs-target="#confirmChange"
                                                       data-href="' . base_url($this->settings['adminkey']."/orders/order_inprogress/" . $row["order_id"]) . '">Yükleniyor</a>
                                                </li>
                                            </ul>
                                        </div>';
                    return $return;
    ...
    public function getallLogs()
    {
        ...
        $colums = array(
            ...
            array(
                ...
                "formatter" => function ($d, $row) {
                    $d = $row['id'];
                    $cikis = ' <a href="' . base_url() . '/'.$this->settings['adminkey'].'/logs/delete/' . $d . '"><i class="fas fa-trash text-danger"></i></a>';
                    return $cikis;
                }
            ),
    ...
    public function getallGuardLogs()
    {
        ...
        $colums = array(
            ...
            array(
                ...
                "formatter" => function ($d, $row) {
                    $d = $row['id'];
                    $cikis = ' <a href="' . base_url() . '/'.$this->settings['adminkey'].'/guard_logs/delete/' . $d . '"><i class="fas fa-trash text-danger"></i></a>';
                    return $cikis;
                }
            ),
    ...
    public function getallServiceLogs()
    {
        ...
        $colums = array(
            ...
            array(
                ...
                "formatter" => function ($d, $row) {
                    $d = $row['id'];
                    $cikis = ' <a href="' . base_url() . '/'.$this->settings['adminkey'].'/provider_logs/delete/' . $d . '"><i class="fas fa-trash text-danger"></i></a>';
                    return $cikis;
                }
            ),
            ...
            array(
                ...
                "formatter" => function ($d, $row) {
                    ...
                    $cikis = '<div class="dropdown text-center">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">';
                    $cikis .= '<li><a class="dropdown-item" href="' . base_url($this->settings['adminkey']."/client-detail/" . $d) . '">Müşteri Detayı</a></li>';
                    $cikis .= '<li><a class="dropdown-item" href="' . base_url($this->settings['adminkey']."/clients/login/" . $d) . '">Giriş Yap</a></li>';
                    ...
                    $cikis .= '<li><a class="dropdown-item" href="' . base_url($this->settings['adminkey']."/clients/del_price/" . $d) . '">İndirimleri Sil</a></li>';
                    $cikis .= '<li><a class="dropdown-item" href="' . base_url($this->settings['adminkey']."/orders?client=" . $row["username"]) . '">Siparişleri Gör</a></li>';
                    $cikis .= '</ul></div>';
                    return $cikis;
                }
            ),
                ...
                "formatter" => function ($d, $row) {
                    ...
                    $cikti = '<div class="dropdown pull-right">
                     <button class="btn btn-secondary dropdown-toggle " type="button"
                       ...
                       <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">';
                    $cikti .= '<li><a class="dropdown-item" href="' . base_url($this->settings['adminkey']."/tasks/no/" . $row["task_id"]) . '">Reddet</a></li>';
                    if ($row["task_type"] == 2) {
                        $cikti .= '<li><a class="dropdown-item" href="' . base_url($this->settings['adminkey']."/tasks/success/" . $row["task_id"]) . '">Onayla</a></li>';
                    } elseif ($row["task_type"] == 1) {
                        $cikti .= '<li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="' . base_url($this->settings['adminkey']."/tasks/canceled/" . $row["task_id"]) . '">İptal ve iade et</a></li>';
        ...
        $colums = array(
            ...
            array(
                ...
                "formatter" => function ($d, $row) {
                    ...
                    return '<a href="' . base_url($this->settings['adminkey']."/tickets/read/" . $row["ticket_id"]) . '" class="text-glycon">' . $row["username"] . '<i class="fas fa-external-link-alt"></i></a>';
                }
            ...
            array(
                ...
                "formatter" => function ($d, $row) {
                    $username = $row['username'];
                    return '<a href="' . base_url($this->settings['adminkey']."/tickets/read/" . $row["ticket_id"]) . '" class="text-glycon">' . $row["subject"] . '<i class="fas fa-external-link-alt"></i></a>';
                }
            ...
            array(
                ...
                "formatter" => function ($d, $row) {
                    $username = $row['username'];
                    return '<a href="' . base_url($this->settings['adminkey']."/tickets/read/" . $row["ticket_id"]) . '" class="text-glycon"><i class="fas fa-search text-dark"></i></a>';
                }
            ...
            array(
                ...
                "formatter" => function ($d, $row) {
                    $username = $row['username'];
                    return '<a href="' . base_url($this->settings['adminkey']."/tickets/close/" . $row["ticket_id"]) . '" class="text-glycon"><i class="fas fa-trash text-danger"></i></a>';
                }
