        ...
        if ($action == "providers_list") {
            ...
            foreach ($grouped as $category) {
                ...
                if ($category[0]["category_secret"] == 1) {
                    ...
                    $return.= " class=\"tiny-toggle\" data-tt-palette=\"blue\" data-url=\"" . base_url($this->settings['adminkey'] . "/clients/secret_category/" . $id) . "\" data-id=\"" . $category[0]["category_id"] . "\"> ";
                }
                ...
                for ($i = 0;$i < count($category);$i++) {
                    ...
                    if ($category[$i]["service_secret"] == 1) {
                        ...
                        $return.= "  class=\"tiny-toggle\" data-tt-palette=\"blue\" data-url=\"" . base_url($this->settings['adminkey'] . "/clients/secret_service/" . $id) . "\" data-id=\"" . $category[$i]["service_id"] . "\">";
                    }
                    $return.= "</span>\r\n\r\n                                     </label>\r\n\r\n                                    </li>";
                }
                $return.= "</ul>\r\n\r\n                             </div>\r\n\r\n                          </span>";
            ...
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/clients/new") . "\" method=\"post\" data-xhr=\"true\">\r\n\r\n        <div class=\"modal-body\">\r\n\r\n";
            ...
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/clients/edit/" . $user["username"]) . "\" method=\"post\" data-xhr=\"true\">\r\n\r\n        <div class=\"modal-body\">\r\n\r\n";
            ...
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/services/new-service") . "\" method=\"post\" data-xhr=\"true\">\r\n        <div class=\"modal-body\">";
            ...
            if (in_array($serviceInfo["service_package"], ["11", "12", "13", "14", "15"])) {
                $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/services/edit-subscription/" . $serviceInfo["service_id"]) . "\" method=\"post\" data-xhr=\"true\">\r\n            <div class=\"modal-body\">";
                if (1 < count($languages)) {
                    $translationList = "<a class=\"other_services\"> Çeviriler (" . (count($languages) - 1) . ") </a>";
                } else {
                    $translationList = "";
            ...
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/services/edit-description/" . $serviceInfo["service_id"]) . "\" method=\"post\" data-xhr=\"true\">\r\n            <div class=\"modal-body\">";
            if (1 < count($languages)) {
                $translationList = "<a class=\"other_services\"> Çeviriler (" . (count($languages) - 1) . ") </a>";
            } else {
                $translationList = "";
            ...
            $providers->execute([]);
            $providers = $providers->fetchAll(PDO::FETCH_ASSOC);
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/services/new-subscription") . "\" method=\"post\" data-xhr=\"true\">\r\n        <div class=\"modal-body\">";
            if (1 < count($languages)) {
                $translationList = "<a class=\"other_services\"> Çeviriler (" . (count($languages) - 1) . ") </a>";
            } else {
                $translationList = "";
            ...
            $category->execute(["id" => $id]);
            $category = $category->fetch(PDO::FETCH_ASSOC);
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/services/edit-category-aciklama/" . $id) . "\" method=\"post\" data-xhr=\"true\">\r\n\r\n        <div class=\"modal-body\">\r\n          <div class=\"form-group\">\r\n            <label class=\"form-group__service-name\">Açıklama</label>\r\n            <textarea type=\"text\" class=\"form-control\" id=\"tinymce$id\" name=\"name\"></textarea>\r\n          </div>";
            $return.= " </div>\r\n\r\n          <div class=\"modal-footer\">\r\n            <button type=\"submit\" class=\"btn btn-primary\">Kategoriyi güncelle</button>\r\n            <button type=\"button\" class=\"btn btn-default\" data-bs-dismiss=\"modal\">Vazgeç</button>\r\n          </div>\r\n          </form>";
            $return.= '
            ...
            $category->execute(["id" => $id]);
            $category = $category->fetch(PDO::FETCH_ASSOC);
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/services/edit-service-aciklama/" . $id) . "\" method=\"post\" data-xhr=\"true\">\r\n\r\n        <div class=\"modal-body\">\r\n          <div class=\"form-group\">\r\n            <label class=\"form-group__service-name\">Açıklama</label>\r\n            <textarea type=\"text\" class=\"form-control\" id=\"tinymce$id\" name=\"name\">" . $category['service_description'] . "</textarea>\r\n          </div>";
            $return.= " </div>\r\n\r\n          <div class=\"modal-footer\">\r\n            <button type=\"submit\" class=\"btn btn-primary\">Kategoriyi güncelle</button>\r\n            <button type=\"button\" class=\"btn btn-default\" data-bs-dismiss=\"modal\">Vazgeç</button>\r\n          </div>\r\n          </form>";
            $return.= '
                                                                    <script src="/assets/css/admin/tinytoggle.min.css"></script>
                                                                    <script>
                                                                          ...
                                                                          */
                                                                          var initSampleajax = ( function() {
	var wysiwygareaAvailable = isWysiwygareaAvailable(),
		isBBCodeBuiltIn = !!CKEDITOR.plugins.get( "bbcode" );

	return function() {
		var editorElement = CKEDITOR.document.getById( "tinymce'.$id.'" );
...
initSampleajax();
            ...
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/services/get_services_add/") . "\" method=\"post\" data-xhr=\"true\">\r\n    \r\n        <div class=\"modal-body\">\r\n\r\n          <div id=\"firstStep\">\r\n            <div class=\"service-mode__block\">\r\n              <div class=\"form-group\">\r\n              <label>Servis Sağlayıcısı</label>\r\n                <select class=\"form-control\" name=\"provider\" id=\"provider\">\r\n                      <option value=\"0\">Servis sağlayıcı seçiniz...</option>";
            foreach ($providers as $provider) {
                $return.= "<option value=\"" . $provider["id"] . "\">" . $provider["api_name"] . "</option>";
            }
        ...
        } elseif ($action == "edit_paymentmethod" && $_POST["id"] == "payhesap") {
            $id = $_POST["id"];
            ...
            echo json_encode(["content" => $return, "title" => "Ödeme methodu düzenle (Method: " . $method["method_name"] . ")"]);
        } elseif ($action == "edit_paymentmethod" && $_POST["id"] == "weepay") {
            $id = $_POST["id"];
            $method = $conn->prepare("SELECT * FROM payment_methods WHERE method_get=:id ");
            $method->execute(["id" => $id]);
            $method = $method->fetch(PDO::FETCH_ASSOC);
            ...
            $return.= "</code>\r\n                </li>
                <li>
                  OSB Bildirim URL (Shopier &rarr; Ek &Ouml;zellikler &rarr; Sipariş Bildirimi &rarr; Bildirim URL): <code>https://merkezbayim.com/shopier-notify.php</code>
                </li>\r\n              </ul>\r\n            </p>\r\n          <hr>\r\n\r\n          <div class=\"form-group\">\r\n            <label class=\"form-group__service-name\">&#128273; API Anahtarı <small style=\"color:#999;\"><strong>Format:</strong> <code>OSB_Kullanici_Adi|||PAT_Token</code><br>(OSB Kullanıcı Adı: Shopier &rarr; Ek &Ouml;zellikler &rarr; Sipariş Bildirimi &nbsp;|&nbsp; PAT Token: Shopier &rarr; Hesap Yönetimi &rarr; Kişisel Erişim Anahtarı)</small></label>\r\n            <input type=\"text\" class=\"form-control\" name=\"apiKey\" value=\"" . $extra["apiKey"] . "\">\r\n          </div>\r\n          <div class=\"form-group\">\r\n            <label class=\"form-group__service-name\">&#128274; OSB Şifresi <small style=\"color:#999;\">(Shopier Panel &rarr; Ek &Ouml;zellikler &rarr; Sipariş Bildirimi &rarr; <strong>OSB Şifresi</strong>)</small></label>\r\n            <input type=\"text\" class=\"form-control\" name=\"apiSecret\" value=\"" . $extra["apiSecret"] . "\">\r\n          </div>\r\n          <div class=\"form-group\">\r\n          <label>Geri dönüş</label>\r\n            <select class=\"form-control\" name=\"website_index\">\r\n                  <option value=\"1\"";
            ...
            echo json_encode(["content" => $return, "title" => "Ödeme methodu düzenle (Method: " . $method["method_name"] . ")"]);
        } elseif ($action == "edit_paymentmethod" && $_POST["id"] == "shoplemo") {
            $id = $_POST["id"];
            $method = $conn->prepare("SELECT * FROM payment_methods WHERE method_get=:id ");
            $method->execute(["id" => $id]);
            $method = $method->fetch(PDO::FETCH_ASSOC);
            ...
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/settings/payment-bonuses/new") . "\" method=\"post\" data-xhr=\"true\">\r\n        <div class=\"modal-body\">\r\n\r\n          <div class=\"form-group\">\r\n          <label>Method</label>\r\n            <select class=\"form-control\" name=\"method_type\">";
            ...
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/payments/edit-bank/" . $id) . "\" method=\"post\" data-xhr=\"true\">\r\n\r\n        <div class=\"modal-body\">\r\n\r\n          <div class=\"service-mode__block\">\r\n            <div class=\"form-group\">\r\n            <label>Ödeme yapılan banka</label>\r\n              <select class=\"form-control\" name=\"bank\">";
            ...
            $bank->execute();
            $bank = $bank->fetchAll(PDO::FETCH_ASSOC);
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/payments/new-bank/") . "\" method=\"post\" data-xhr=\"true\">\r\n\r\n        <div class=\"modal-body\">\r\n\r\n\r\n          <div class=\"form-group\">\r\n            <label class=\"form-group__service-name\">Kullanıcı adı</label>\r\n            <input type=\"text\" class=\"form-control\" name=\"username\" value=\"\">\r\n          </div>\r\n\r\n          <div class=\"form-group\">\r\n            <label class=\"form-group__service-name\">Tutar</label>\r\n            <input type=\"text\" class=\"form-control\" name=\"amount\" value=\"\">\r\n          </div>\r\n\r\n          <div class=\"service-mode__block\">\r\n            <div class=\"form-group\">\r\n            <label>Ödeme yapılan banka</label>\r\n              <select class=\"form-control\" name=\"bank\">";
            foreach ($bank as $banka) {
            ...
            $methodList->execute([]);
            $methodList = $methodList->fetchAll(PDO::FETCH_ASSOC);
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/settings/payment-bonuses/edit/" . $id) . "\" method=\"post\" data-xhr=\"true\">\r\n        <div class=\"modal-body\">\r\n\r\n          <div class=\"form-group\">\r\n          <label>Method</label>\r\n            <select class=\"form-control\" name=\"method_type\">";
            foreach ($methodList as $method) {
            ...
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/clients/price/" . $id) . "\" method=\"post\" data-xhr=\"true\">\r\n        <div class=\"modal-body\">\r\n\r\n        <div class=\"majer\">\r\n               <div>\r\n                  <div class=\"services-import__list-wrap services-import__list-active\">\r\n                     <div class=\"services-import__scroll-wrap\">\r\n                        <span>\r\n                             <div class=\"services-import__packages\">\r\n                                <ul>";
            ...
            $row = $row->fetch(PDO::FETCH_ASSOC);
            $detail = json_decode($row["order_detail"]);
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/orders/set_orderurl/" . $id) . "\" method=\"post\">\r\n        <div class=\"modal-body\">\r\n\r\n          <div class=\"service-mode__block\">\r\n            <div class=\"form-group\">\r\n            <label>Sipariş Bağlantısı</label>\r\n              <input class=\"form-control\" value=\"" . $row["order_url"] . "\" name=\"url\">\r\n            </div>\r\n          </div>\r\n\r\n\r\n        </div>\r\n\r\n          <div class=\"modal-footer\">\r\n            <button type=\"submit\" class=\"btn btn-primary\">Ayarları güncelle</button>\r\n            <button type=\"button\" class=\"btn btn-default\" data-bs-dismiss=\"modal\">Vazgeç</button>\r\n          </div>\r\n          </form>";
            echo json_encode(["content" => $return, "title" => "Sipariş detayları (ID: " . $row["order_id"] . ") "]);
            ...
            $row = $row->fetch(PDO::FETCH_ASSOC);
            $detail = json_decode($row["order_detail"]);
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/orders/set_startcount/" . $id) . "\" method=\"post\">\r\n        <div class=\"modal-body\">\r\n\r\n          <div class=\"service-mode__block\">\r\n            <div class=\"form-group\">\r\n            <label>Başlangıç sayısı</label>\r\n              <input class=\"form-control\" value=\"" . $row["order_start"] . "\" name=\"start\">\r\n            </div>\r\n          </div>\r\n\r\n\r\n        </div>\r\n\r\n          <div class=\"modal-footer\">\r\n            <button type=\"submit\" class=\"btn btn-primary\">Ayarları güncelle</button>\r\n            <button type=\"button\" class=\"btn btn-default\" data-bs-dismiss=\"modal\">Vazgeç</button>\r\n          </div>\r\n          </form>";
            echo json_encode(["content" => $return, "title" => "Sipariş detayları (ID: " . $row["order_id"] . ") "]);
            ...
            $row = $row->fetch(PDO::FETCH_ASSOC);
            $detail = json_decode($row["order_detail"]);
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/orders/set_partial/" . $id) . "\" method=\"post\" data-xhr=\"true\">\r\n        <div class=\"modal-body\">\r\n\r\n          <div class=\"service-mode__block\">\r\n            <div class=\"form-group\">\r\n            <label>Gitmeyen miktar</label>\r\n              <input class=\"form-control\" name=\"remains\">\r\n            </div>\r\n          </div>\r\n\r\n        </div>\r\n\r\n          <div class=\"modal-footer\">\r\n            <button type=\"submit\" class=\"btn btn-primary\">Ayarları güncelle</button>\r\n            <button type=\"button\" class=\"btn btn-default\" data-bs-dismiss=\"modal\">Vazgeç</button>\r\n          </div>\r\n          </form>";
            echo json_encode(["content" => $return, "title" => "Sipariş detayları (ID: " . $row["order_id"] . ") "]);
            ...
            $row = $row->fetch(PDO::FETCH_ASSOC);
            $detail = json_decode($row["order_detail"]);
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/subscriptions/set_expiry/" . $id) . "\" method=\"post\">\r\n        <div class=\"modal-body\">\r\n\r\n          <div class=\"service-mode__block\">\r\n            <div class=\"form-group\">\r\n            <label>Başlangıç sayısı</label>\r\n              <input class=\"form-control datetime\" value=\"";
            ...
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/payments/edit-online/" . $id) . "\" method=\"post\" data-xhr=\"true\">\r\n\r\n        <div class=\"modal-body\">\r\n\r\n          <div class=\"service-mode__block\">\r\n            <div class=\"form-group\">\r\n            <label>Ödeme yöntemi</label>\r\n              <select class=\"form-control\" name=\"method\">";
        ...
        } elseif ($action == "module_ref") {
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/settings/modules/ref") . "\" method=\"post\" data-xhr=\"true\">    \r\n        <div class=\"modal-body\">\r\n        <div class=\"form-group\">\r\n              <label class=\"control-label\">Referans Sistemi</label>\r\n              <select class=\"form-control\" name=\"referral\">\r\n                <option value=\"2\" ";
        ...
        } elseif ($action == "module_child") {
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/settings/modules/module_child") . "\" method=\"post\" data-xhr=\"true\">\r\n\r\n        <div class=\"modal-body\">\r\n\r\n     \r\n     <div class=\"form-group\">\r\n          <label class=\"control-label\">Child panel Satışı</label>\r\n          <select class=\"form-control\" name=\"panel_selling\">\r\n            <option value=\"2\" ";
        ...
        } elseif ($action == "module_balance") {
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/settings/modules/module_balance") . "\" method=\"post\" data-xhr=\"true\">\r\n\r\n        <div class=\"modal-body\">\r\n\r\n     \r\n     <div class=\"form-group\">\r\n          <label class=\"control-label\">Ücretsiz Bakiye</label>\r\n          <select class=\"form-control\" name=\"free_balance\">\r\n            <option value=\"2\" ";
        ...
        } elseif ($action == "module_cache") {
            $return = "<form class=\"form\" action=\"" . base_url($this->settings['adminkey'] . "/settings/modules/module_cache") . "\" method=\"post\" data-xhr=\"true\">\r\n\r\n        <div class=\"modal-body\">\r\n\r\n     \r\n     <div class=\"form-group\">\r\n          <label class=\"control-label\">Cache Sistemi</label>\r\n          <select class=\"form-control\" name=\"cache\">\r\n            <option value=\"2\" ";
            if ($settings["cache"] == 2) {
                $return.= "selected";
            }
            $return.= ">Aktif</option>\r\n            <option value=\"1\" ";
