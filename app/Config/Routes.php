...
$routes->group($settings['adminkey'], ['filter' => 'adminLogin'], function ($routes) {
    $routes->add('login', 'admin/Main::login');
});
$routes->group($settings['adminkey'], ['filter' => 'adminControl'], function ($routes) {
    ...
    $routes->add('glycon-managements', 'admin/UManagements::index');
    $routes->add('glycon-managements/(:any)', 'admin/UManagements::index');
