                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12 navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse w-100 w-sm-auto float-end" id="card-Nav">
                                ...
                                <a href="<?= base_url($settings['adminkey']."/payments/bank"); ?>"
...
<script>
    $(document).ready(function () {
        var oTable = $('#payments').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "<?= (route(3) == "bank" && route(3))?base_url($settings['adminkey'].'/getallPaymentsBank'):base_url($settings['adminkey'].'/getallPayments')?>",
            "bFilter": true,
            "bInfo": false,
            "bAutoWidth": false,
            dom: 'lrtp',
