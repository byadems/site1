...
<div class="container-fluid px-sm-5">
    <div class="row">
        <div class="col-md-12 collapse ms-auto mb-3" id="filter">
            <a href="<?=base_url($settings['adminkey']."/dripfeeds")?>"
               class="btn btn-primary bg-gradient w-100 w-sm-auto my-1 my-0">Tümü</a>
            <a href="<?=base_url($settings['adminkey']."/dripfeeds/1/active")?>"
               class="btn btn-warning bg-gradient w-100 w-sm-auto my-1 my-0">Aktif</a>
            <a href="<?=base_url($settings['adminkey']."/dripfeeds/1/completed")?>"
               class="btn btn-info bg-gradient w-100 w-sm-auto my-1 my-0">Tamamlandı</a>
            <a href="<?=base_url($settings['adminkey']."/dripfeeds/1/canceled")?>"
        ...
        <div class="col-md-12 collapse ms-auto mb-3" id="search">
            <form class="form-inline" action="<?=base_url($settings['adminkey']."/dripfeeds")?>" method="get">
        ...
        <div class="col-md-12">
                ...
                <div class="card-header p-0">
                    <div class="row align-items-center">
                        <div class="col-md-12 navbar-expand-lg">
                            <div class="card-header-title">Dripfeeds</div>
            ...
            <th></th>
              ...
              <tr>
                 ...
                 <td><?php echo "<a href='#'>".$order["dripfeed_delivery"]."</a>/".$order["dripfeed_runs"]; ?></td>
                   ...
                   <div class="dropdown pull-right">
                    <button class="btn btn-secondary dropdown-toggle " type="button"
                     ...
                     <ul class="dropdown-menu">
                           ...
                           <li><a href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=site_url($settings['adminkey']."/dripfeeds/dripfeed_canceled/".$order["order_id"])?>">Canceled</a></li>
                           <li><a href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=site_url($settings['adminkey']."/dripfeeds/dripfeed_completed/".$order["order_id"])?>">Completed</a></li>
                           <li><a href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=site_url($settings['adminkey']."/dripfeeds/dripfeed_canceledbalance/".$order["order_id"])?>">Canceled and Check-in</a></li>
