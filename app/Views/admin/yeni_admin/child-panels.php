...
<div class="container-fluid px-sm-5">
    <div class="row">
        ...
        <div class="col-md-12 collapse ms-auto mb-3" id="search">
            <form class="form-inline" action="<?=base_url($settings['adminkey']."/child-panels")?>" method="get">
     ...
     <li  ><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=base_url($settings['adminkey']."/child-panels/cancel/".$panel["id"])?>" >İptal ve İade Et</a></li>
