                    ...
                    <div class="card-header p-0">
                        <div class="row align-items-center">
                            <div class="col-md-12">
								...
								<a href="javascript::void(0)" data-bs-toggle="modal" data-bs-focus="false" data-bs-target="#popupadd" class="btn-glycon btn-glycon-success btn-card-header w-100 w-sm-auto">
                        ...
                        <table class="table border table-striped m-0">
                          ...
                          <tr>
                             ...
                             <td><?php if($popup["zaman"] == 1){echo "Saatte bir gösteriliyor";}elseif($popup["zaman"] == 2){echo "3 Saatte bir gösteriliyor";}elseif($popup["zaman"] == 3){echo "6 Saatte bir gösteriliyor";}elseif($popup["zaman"] == 4){echo "12 Saatte bir gösteriliyor";}elseif($popup["zaman"] == 5){echo "Günde bir gösteriliyor";} ?></td>
                              ...
                              <a style="margin-left:.3rem;" href="<?= base_url()?>/<?= $settings['adminkey']; ?>/popup?delete=<?= $popup['id']?>"><i class="fas fa-trash text-danger"></i></a>
                                    </td>
                          </tr>
...
<div class="modal fade" id="popupadd" aria-labelledby="popupadd" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="message-text" class="col-form-label">İçerik:</label>
            <textarea class="form-control" id="editor" name="icerik"></textarea>
          </div>
          <div class="mb-3">
