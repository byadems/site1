                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12 navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse w-100 w-sm-auto float-end" id="card-Nav">
                                <a href="<?= base_url($settings['adminkey']."/new-service") ?>"
...
<div class="modal fade in modal-fullscreen-xl" id="modalDivDuzenle" data-backdrop="static" role="dialog"
...
<script>
    ...
    $(document).ready(function () {
        $('.loading').show();
        $.get("<?= base_url($settings['adminkey']."/services-ajax")?>", {}, function (data) {
            $('.loading').hide();
