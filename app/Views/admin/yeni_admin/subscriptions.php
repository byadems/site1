...
<div class="container-fluid px-sm-5">
    <div class="row">
        ...
        <div class="col-md-12 collapse ms-auto mb-3" id="search">
            <form class="form-inline" action="<?=base_url($settings['adminkey']."/subscriptions")?>" method="get">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body mobile-overflow p-0">
                         <form id="changebulkForm" action="<?php echo base_url($settings['adminkey']."/subscriptions/multi-action") ?>" method="post">
                   ...
                   <div class="dropdown pull-right">
                     ...
                     <ul class="dropdown-menu">
                       ...
                       <?php if( $order["subscriptions_status"] == "active" ): ?>
                         <li><a href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=base_url($settings['adminkey']."/subscriptions/subscriptions_pause/".$order["order_id"])?>">Durdur</a></li>
                       <?php endif; ?>
                       <?php if( $order["subscriptions_status"] == "paused" || $order["subscriptions_status"] == "active" ): ?>
                         <li><a href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=base_url($settings['adminkey']."/subscriptions/subscriptions_complete/".$order["order_id"])?>">Tamamla</a></li>
                       <?php endif; ?>
                       <?php if( $order["subscriptions_status"] == "paused" || $order["subscriptions_status"] == "expired" || $order["subscriptions_status"] == "canceled" ): ?>
                         <li><a href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=base_url($settings['adminkey']."/subscriptions/subscriptions_active/".$order["order_id"])?>">Aktifleştir</a></li>
                       <?php endif; ?>
                       <?php if( $order["subscriptions_status"] == "paused" || $order["subscriptions_status"] == "active" ): ?>
                         <li><a href="#" data-bs-toggle="modal" data-bs-target="#confirmChange" data-href="<?=base_url($settings['adminkey']."/subscriptions/subscriptions_canceled/".$order["order_id"])?>">İptal Et</a></li>
                       <?php endif; ?>
                     </ul>
                   </div>
                 </td>
