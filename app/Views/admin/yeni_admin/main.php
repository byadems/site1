        ...
        <?php if ($user['access']['orders']) : ?>
            <div class="col-md-3">
                <div class="card text-white bg-glycon mb-3">
                    ...
                    <div class="card-body card-glycon">
                        <h5 class="card-title text-center fw-bold fs-1"><?php if (isset($fail)) : echo $fail;
                                                                        else : echo "0";
                                                                        endif; ?></h5>
                    </div>
                </div>
                    ...
                    <table class="table border table-striped">
                        ...
                        <tbody>
                            <?php foreach ($orders as $order) { ?>
                                <tr>
                                    <th scope="row"><a href="<?= base_url($settings['adminkey'] . "") ?>/order-detail/<?= $order['order_id'] ?>">#<?= $order['order_id'] ?></a></th>
                                    <td>
        ...
        <div class="col-md-6">
            <div>
                <div class="form-floating">
                    <textarea class="form-control" style="height: 270px;" onkeypress="notkaydet();" placeholder="Leave a comment here" id="floatingTextarea"><?= $settings['notlar'] ?></textarea>
...
<script>
    function notkaydet() {
        ...
        $.post('<?= base_url("/".$settings['adminkey']."/notkaydet")?>', {not:not});
    }
</script>
