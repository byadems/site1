                ...
                <td class="text-center w-10 align-middle">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu"
                            ...
                            <li><a class="dropdown-item"
                                   href="<?= base_url($settings['adminkey'].'/') ?>/services-detail/<?= $services["service_id"] ?>">Düzenle</a>
                            </li>

                            <li><a class="dropdown-item"
                                   href="<?= base_url($settings['adminkey'].'/') ?>/services/service-copy/<?= $services["service_id"] ?>">Servisi
                                    Kopyala</a>
                            </li>
                            <li><a class="dropdown-item"
                                   href="<?php echo base_url($settings['adminkey']."/services/del_price/" . $services["service_id"]) ?>">İndirimleri
                                    Sıfırla</a>
                            </li>
                            ...
                            <?php if ($services["service_type"] == 1) { ?>
                                <li><a class="dropdown-item"
                                       href="<?= base_url($settings['adminkey'].'/') ?>/services/service-active/<?= $services["service_id"] ?>">Servisi
                                        Aktifleştir</a></li>
                            <?php } else { ?>
                                <li><a class="dropdown-item"
                                       href="<?= base_url($settings['adminkey'].'/') ?>/services/service-deactive/<?= $services["service_id"] ?>">Servisi
                                        Pasifleştir</a></li>
                            <?php } ?>
                            <li><a class="dropdown-item"
                                   ...
                                   data-href="<?php echo base_url($settings['adminkey']."/services/delete/" . $services["service_id"]) ?>">Servisi
                                    Sil</a></li>
                            <li><a class="dropdown-item"
                                   href="<?= base_url($settings['adminkey'].'/') ?>/orders?services=<?= $services["service_id"] ?>">Siparişleri
                                    Gör</a></li>
                        </ul>
                    </div>
                </td>
