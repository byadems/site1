				...
				<div class="card-header p-0">
					<div class="row align-items-center">
						<div class="col-md-12 navbar-expand-lg">
							<div class="card-header-title"><?= lang('Admin.files'); ?></div>
							...
							<form action="" method="post" enctype="multipart/form-data">
								<button type="submit" href="#" class="btn-glycon btn-glycon-success btn-card-header w-100 w-sm-auto text-center" ><i class="fas fa-plus"></i> <?= lang('Admin.upload'); ?></button>
					...
					<table class="table border table-striped m-0">
						...
						<tbody class="icon-animation">
							...
							<tr>
								...
								<td>
									<a href="<?= base_url()?>/<?= $settings['adminkey']; ?>/appearance/files/delete/<?=$file['id']?>" class="btn-glycon btn-glycon-danger text-center"><i class="fas fa-times"></i> <?= lang('Admin.delete'); ?></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
