    ...
    <div class="container-fluid px-sm-5">
        <div class="row">
            <div class="col-md-12 collapse ms-auto mb-3" id="collapseExample">
                <form class="form-inline" action="<?= base_url($settings['adminkey']."/logs") ?>" method="get">
                    ...
                    <div class="card-header p-0">
                        <div class="row align-items-center">
                            <div class="col-md-12">
								...
								<a href="<?= base_url($settings['adminkey']."/provider_logs") ?>" class="btn-glycon btn-glycon-success btn-card-header w-100 w-sm-auto">
                                    <i class="fas fa-search"></i> Sağlayıcı Logları
                                </a>
								<a href="<?= base_url($settings['adminkey']."/guard_logs") ?>" class="btn-glycon btn-glycon-warning btn-card-header w-100 w-sm-auto">
                                    <i class="fas fa-search"></i> Guard Logları
                                </a>
								<a href="<?= base_url($settings['adminkey']."/logs") ?>" class="btn-glycon btn-glycon-primary btn-card-header w-100 w-sm-auto">
                    ...
                    <div class="card-body mobile-overflow p-0">
                        <table class="table border table-striped m-0" id="logs">
                            ...
                            <tr>
								...
								<th class="text-center" scope="col">Detay</th>
...
<script>
    $(document).ready(function () {
        var oTable = $('#logs').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "<?= base_url($settings['adminkey'].'/getallServiceLogs')?>",
            "bFilter": true,
            "bInfo": false,
            "bAutoWidth": false,
            dom: 'lrtp',
