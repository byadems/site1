				...
				<div class="card-header p-0">
					<div class="row align-items-center">
						<div class="col-md-12">
							...
							<?php if ($type == "active") : ?>
								<a href="<?php echo base_url($settings['adminkey'] . "/clients/" . $type . "/" . $client["client_id"]) ?>" class="btn-glycon btn-glycon-success btn-card-header"><i class="fas fa-plus"></i> Üyenin Yasağını Kaldır</a>
							<?php else : ?>
								<a href="<?php echo base_url($settings['adminkey'] . "/clients/" . $type . "/" . $client["client_id"]) ?>" class="btn-glycon btn-glycon-danger btn-card-header"><i class="fas fa-plus"></i> Üyeyi Yasakla</a>
							...
							<tbody>
								<?php foreach ($ticket as $t) { ?>
									<tr>
										...
										<td><a href="<?= base_url($settings['adminkey'] . '//tickets/read/' . $t['ticket_id']) ?>"><?= $t['subject'] ?></a></td>
										<td class="text-center">
											<?php
