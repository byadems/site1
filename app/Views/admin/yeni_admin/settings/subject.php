...
<div class="col-md-10">
<a href="/<?= $settings['adminkey']; ?>/settings/modules" class="details_backButton btn btn-link"><span>‹</span> Geri</a>
                                       ...
                                       <?php foreach($subjectList as $subject): ?>
                                        <li class="dd-item ui-sortable-handle">
                                            ...
                                            <div class="settings-menu__action">
                                                ...
                                                <a href="<?php echo base_url($settings['adminkey'].'/settings/subject/edit/'.$subject["subject_id"].'') ?>" class="btn btn-default btn-xs edit-modal-menu">Düzenle</a>
                                            </div>
                                        </li>
                                        <?php endforeach; ?>
    ...
    <div class="panel-body">
         ...
         <form action="<?php echo base_url($settings['adminkey'].'/settings/subject') ?>" method="post" enctype="multipart/form-data">
...
<div class="col-md-10">
    <a href="<?= base_url();?>/<?= $settings['adminkey']; ?>/settings/modules" class="details_backButton btn btn-link"><span>‹</span> Geri</a>
    ...
    <div class="panel-body">
         ...
         <form action="<?php echo base_url($settings['adminkey'].'/settings/subject/edit/'.route(5)) ?>" method="post" enctype="multipart/form-data">
...
<select class="form-control" name="auto_reply">
    ...
    elseif($post["auto_reply"] == 1){echo'selected'; }?>>Aktif</option>
            ...
            <div class="form-group">
               <label class="control-label">Otomatik Yanıtlanacak Mesaj</label>
               <textarea class="form-control" id="editor" rows="5" name="content"><?=$post["content"]?></textarea>
            </div>	  
           <p>Bu konu başlığı altında yeni bir destek talebi oluşturulduğunda otomatik gönderilecek cevap.</p> 
            <hr>
            ...
            <a href="<?php echo base_url($settings['adminkey'].'/settings/subject/delete/'.route(5)) ?>" class="btn btn-link pull-right deactivate-integration-btn">
                                Sil
                            </a>
