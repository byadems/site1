    ...
    <div class="card">
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <a href="<?= base_url() ?>/<?= $settings['adminkey']; ?>/settings/bank-accounts" class="btn-glycon btn-glycon-success btn-card-header"><i class="fas fa-plus"></i> Banka
                Hesapları</a>
                </div>
            </div>
        </div>
                            ...
                            <div class="glycon-module-image">
                                ...
                                <?php if ($method["method_type"] == 2) { ?>
                                    <a href="#" class="btn-glycon btn-glycon-danger btn-glycon-module payment-methods"
                                       data-status="pasif"
                                       data-url="<?= base_url($settings['adminkey']."/settings/payment-methods/type") ?>"
