        ...
        <div class="card-body">
            <div class="row">
                <?php foreach( $active_modules as $module ){ ?>
						<div class="col-md-4">
							<div class="glycon-module-card" style="min-height:275px;">
								<div class="glycon-module-image">
									...
									<a href="<?= base_url()?>/<?= $settings['adminkey']; ?>/settings/subject" class="btn-glycon btn-glycon-primary btn-glycon-module" ><i class="fa fa-cog" aria-hidden="true"></i> Modül Ayarları</a>
                        <?php else: ?>
						...
						<?php endif; ?>
                        <a href="<?= base_url()?>/<?= $settings['adminkey']; ?>/settings/modules/disable/<?=$module["id"]?>" class="btn-glycon btn-glycon-danger btn-glycon-module payment-methods"><i class="fas fa-check" aria-hidden="true"></i>Pasifleştir</a>
								</div>
						...
						<div class="col-md-4">
							<div class="glycon-module-card" style="min-height:275px;">
								<div class="glycon-module-image">
									...
									<a href="<?= base_url()?>/<?= $settings['adminkey']; ?>/settings/modules/enable/<?=$module_1["id"]?>" class="btn-glycon btn-glycon-success btn-glycon-module"><i class="fas fa-check" aria-hidden="true"></i> Aktifleştir</a>
								</div>
								<div class="glycon-module-info">
